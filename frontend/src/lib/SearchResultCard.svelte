...
>
	<div class="flex flex-col gap-6 md:flex-row md:items-start">
		...
		<div class="mb-2 flex flex-col items-center gap-5">
			...
			{#if showAddButton}
				<div class="">
					<button
						on:click={addToEmr}
						class="cursor-pointer rounded-full bg-green-100 px-5 py-3 text-xs font-semibold text-green-800 transition-colors duration-500 hover:bg-green-300 hover:text-zinc-800"
					>
						Add to Patient EMR
					</button>
				</div>
